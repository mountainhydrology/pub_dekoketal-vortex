...
ax.annotate(r'$\delta$T',xy=(0.1,0.25),xycoords='axes fraction',size=20,color='k')
ax.annotate(r'$\delta$T$_0$',xy=(0.1,0.19),xycoords='axes fraction',size=20,color='k')
ax.annotate(r'$\delta$HTAD',xy=(0.1,0.13),xycoords='axes fraction',size=20,color='k')
ax.annotate(r'$\delta$ADH',xy=(0.1,0.07),xycoords='axes fraction',size=20,color='k')
ax.annotate(r'$\delta$DH',xy=(0.1,0.01),xycoords='axes fraction',size=20,color='k')
plt.plot([-720,-670],[0.9,0.9],c='b',linewidth=2.5)
plt.plot([-720,-670],[2.7,2.7],c='r',linewidth=2.5)
plt.plot([-720,-670],[4.6,4.6],c='g',linewidth=2.5)
plt.plot([-720,-670],[6.3,6.3],c='orange',linewidth=2.5)
plt.plot([-720,-670],[8,8],c='grey',linewidth=2.5)
plt.xlabel('Temperature difference (K)')
plt.ylabel('Pressure (hPa)')
plt.savefig('dekoketal_thermo_v2.pdf',bbox_inches='tight') 